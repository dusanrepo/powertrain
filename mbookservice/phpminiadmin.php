...
$ACCESS_PWD='dp'; #!!!IMPORTANT!!! this is script access password, SET IT if you want to protect you DB from public access

#DEFAULT db connection settings
# --- WARNING! --- if you set defaults - it's recommended to set $ACCESS_PWD to protect your db!
$DBDEF=array(
'user'=>"bclweb03sql",#required
'pwd'=>"HApufun?6", #required
'db'=>"bclweb03sql_jlr_powertrain",  #optional, default DB
