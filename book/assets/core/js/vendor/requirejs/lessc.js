...
(function(window, undefined) { //
  ...
  if (typeof(window.less) === 'undefined' || typeof(window.less.nodeType) !== 'undefined') {
    window.less = {};
  }
  less = window.less;
    ...
    parser = {
      ...
      parsers: parsers = {
        ...
        selector: function(isLess) {
          var index = i,
            $re = _$re,
            elements, extendList, c, e, extend, when, condition;
        ...
        rule: function(tryAnonymous) {
          var name, value, startOfRule = i,
            c = input.charAt(startOfRule),
  ...
  (function(tree) {
    ...
    tree.mixin.Call.prototype = {
      ...
      eval: function(env) {
        var mixins, mixin, args, rules = [],
          match = false,
          i, m, f, isRecursive, isOneFound, rule,
          candidates = [],
          candidate, conditionResult = [],
          defaultFunc = tree.defaultFunc,
          defaultResult, defNone = 0,
          defTrue = 1,
          defFalse = 2,
          count;
    ...
    tree.mixin.Definition.prototype = {
      ...
      matchCondition: function(args, env) {
        if (this.condition && !this.condition.eval(
            new(tree.evalEnv)(env, [this.evalParams(env, new(tree.evalEnv)(env, this.frames.concat(env.frames)), args, [])] // the parameter variables
    ...
    tree.Ruleset.prototype = {
      ...
      eval: function(env) {
        var thisSelectors = this.selectors,
          selectors,
          selCnt, selector, i, defaultFunc = tree.defaultFunc,
      ...
      rulesets: function() {
        ...
        var _Ruleset = tree.Ruleset,
          _MixinDefinition = tree.mixin.Definition,
          filtRules = [],
          rules = this.rules,
          cnt = rules.length,
          i, rule;
    ...
    tree.processExtendsVisitor.prototype = {
      ...
      doExtendChaining: function(extendsList, extendsListTarget, iterationCount) {
        ...
        var extendIndex, targetExtendIndex, matches, extendsToAdd = [],
          ...
          selectorPath, extend, targetExtend, newExtend;
  ...
  function loadFile(originalHref, currentFileInfo, callback, env, modifyVars) {
    ...
    if (env.useFileCache && fileCache[href]) {
      try {
        ...
        callback(null, lessText, href, newFileInfo, {
