...
define(["text!./menu.html", "knockout", "jquery", "WebUtility", "jqueryTouchSwipe", "perfectScrollbar", "less!./menu"], function(htmlTemplate, ko, $, WebUtility, swipe, Ps) {
  ...
  function viewModel(params) {
    ...
    mBook.Event("pageLoaded", function() {
      ...
      $('.menu-list ul li div span:contains("Chapter 1")').parent().parent().css('padding-left', '25px');
      $('.menu-list ul li div span:contains("Chapter 2")').parent().parent().css('padding-left', '25px');
  ...
  function section(config, parent, root) {
    ...
    self.toggleSelection = function() {
      //container
      //Davendra - 18/01/2019
      //console.log( root.settings.menuTitle.calculated());
      //console.log( root.settings.menuTitle.length());
      load = false;
      ...
      if (config.section == undefined && self.pageIndex != undefined) {
        parent.selectedSection(self);
        //Davendra - 18/01/2019
        load = mBook.GotoPage(self.pageIndex);
        root.closeMenu();
      }
